...
public class NeighborhoodLocator {
    ...
    private record Zone(String name, double lat, double lon) {}

    private static final List<Zone> ZONES = List.of(
        new Zone("San Pablo",        37.3970, -5.9800),
        new Zone("Polígono Sur",     37.3630, -5.9750),
        new Zone("Torreblanca",      37.3750, -5.9150),
        new Zone("Los Pajaritos",    37.3700, -5.9550),
        new Zone("Palmete",          37.3800, -5.9400),
        new Zone("Cerro del Águila", 37.3720, -5.9700),
        new Zone("Pino Montano",     37.4400, -5.9450),
        new Zone("Alcosa",           37.3950, -5.9200),
        new Zone("Triana",           37.3830, -6.0050),
        new Zone("La Macarena",      37.4150, -5.9850),
        new Zone("Nervión",          37.3850, -5.9750),
        new Zone("San Bernardo",     37.3820, -5.9850),
        new Zone("Bellavista",       37.3400, -5.9760),
        new Zone("San Jerónimo",     37.4350, -5.9600),
        new Zone("Heliópolis",       37.3650, -5.9850),
        new Zone("Los Remedios",     37.3750, -6.0050),
        new Zone("Santa Cruz",       37.3850, -5.9900)
    );
